...
hp@hp-HP-Laptop-15s-fq4xxx:~/Documents/local-ai-agent$ ollama list
...
hp@hp-HP-Laptop-15s-fq4xxx:~/Documents/local-ai-agent$ ^C

- How to run
  (venv) hp@hp-HP-Laptop-15s-fq4xxx:~/Documents/local-ai-agent$ python3 main.py
